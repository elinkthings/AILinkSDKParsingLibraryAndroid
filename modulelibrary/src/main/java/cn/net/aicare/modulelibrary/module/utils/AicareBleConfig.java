...
public class AicareBleConfig {
     ...
     * @param sex 1男,2女
     * @param age 年龄(0~120)
     * @param weight 体重(0~220)
     * @param height 身高(0-269)
     * @param adc 阻抗(0~1000)
     * @return 体脂数据
     */
    public static cn.net.aicare.algorithmutil.BodyFatData getBodyFatData(@AlgorithmUtil.AlgorithmType int type, int sex, int age, double weight, int height, int adc){
