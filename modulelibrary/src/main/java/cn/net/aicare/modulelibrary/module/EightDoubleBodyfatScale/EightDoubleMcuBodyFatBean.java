 ...
 * @date 2024/06/11
 */
public class EightDoubleMcuBodyFatBean {
    ...
    public EightDoubleMcuBodyFatBean() {
    }
     ...
     * 复制
     *
     * @return {@link EightDoubleMcuBodyFatBean}
     */
    public EightDoubleMcuBodyFatBean copy() {
        EightDoubleMcuBodyFatBean bean = new EightDoubleMcuBodyFatBean();
    ...
    public String toString() {
        return "EightDoubleMcuBodyFatBean{" +
                "addData=" + addData +
                "bmi=" + bmi +
                ", bodyBfr=" + bodyBfr +
                ", bodyRom=" + bodyRom +
