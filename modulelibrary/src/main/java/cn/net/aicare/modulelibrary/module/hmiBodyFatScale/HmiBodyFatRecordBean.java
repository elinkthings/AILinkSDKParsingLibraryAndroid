...
public class HmiBodyFatRecordBean {
    ...
    public String toString() {
        return "HmiBodyFatRecordBean{" + "bmi=" + bmi + ", bfr=" + bfr + ", sfr=" + sfr + ", uvi=" + uvi + ", rom=" + rom + ", bmr=" + bmr + ", bm=" + bm + ", vwc=" + vwc + ", heartRate=" + heartRate + ", bodyAge=" + bodyAge + ", pp=" + pp + '}';
    }
}
